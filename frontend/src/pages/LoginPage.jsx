      ...
      <form className="border-2 bg-white/10 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg">
...

        {
          currState === "Sign up" && isDataSubmitted && (
            ...
            rows={4} className='p-2 border border-gray-500 roounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='provide a short bio...' required>
            </textarea> 
          )
        }
